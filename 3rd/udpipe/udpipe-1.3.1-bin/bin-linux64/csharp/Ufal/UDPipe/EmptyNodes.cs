...
public class EmptyNodes : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<EmptyNode>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(EmptyNodes obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  public EmptyNodes(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public EmptyNodes(global::System.Collections.Generic.IEnumerable<EmptyNode> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (EmptyNode element in c) {
      this.Add(element);
  ...
  public EmptyNode[] ToArray() {
    EmptyNode[] array = new EmptyNode[this.Count];
    this.CopyTo(array);
    return array;
  }
