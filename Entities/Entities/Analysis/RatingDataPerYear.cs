...
namespace HlidacStatu.Entities.Entities.Analysis
{
    public class RatingDataPerYear : DataPerYear<RatingData>
    {
        ...
        protected virtual void Init(Dictionary<int, RatingData> dataFromDb, BasicDataPerYear basicData)
        {
            ...
            //add summary
            Data.Add(AllYearsSummaryKey, new RatingData()
            {
            ...
            Data[AllYearsSummaryKey].PercentBezCeny =
                basicData.Summary.Pocet == 0 ? 0 : (decimal)Data[AllYearsSummaryKey].NumBezCeny / basicData.Summary.Pocet;
            Data[AllYearsSummaryKey].PercentBezSmluvniStrany =
                basicData.Summary.Pocet == 0 ? 0 : (decimal)Data[AllYearsSummaryKey].NumBezSmluvniStrany / basicData.Summary.Pocet;
            Data[AllYearsSummaryKey].PercentKcBezSmluvniStrany =
                basicData.Summary.CelkemCena == 0 ? 0 : (decimal)Data[AllYearsSummaryKey].SumKcBezSmluvniStrany / basicData.Summary.CelkemCena;
            Data[AllYearsSummaryKey].PercentSPolitiky =
                basicData.Summary.Pocet == 0 ? 0 : (decimal)Data[AllYearsSummaryKey].NumSPolitiky / basicData.Summary.Pocet;
            Data[AllYearsSummaryKey].PercentKcSPolitiky =
                basicData.Summary.CelkemCena == 0 ? 0 : ((decimal)(Data[AllYearsSummaryKey].SumKcSPolitiky) / (decimal)basicData.Summary.CelkemCena);
