...
public partial class Dotace
{
    public partial class Hint
    {
        ...
        public int RecipientTypSubjektu { get; set; } = (int)HlidacStatu.Entities.Firma.TypSubjektuEnum.Neznamy;

        [Newtonsoft.Json.JsonIgnore]
        [System.Text.Json.Serialization.JsonIgnore]
        [Nest.Ignore]
        public Firma.TypSubjektuEnum RecipientTypSubjektuEnum
        {
            get => (Firma.TypSubjektuEnum)this.RecipientTypSubjektu;
        }
        ...
        [System.Text.Json.Serialization.JsonIgnore]
        [Nest.Ignore]
        public string RecipientStatusFull
        {
            get => Firma.StatusFull(this.RecipientStatus, false);
        }
        ...
        [System.Text.Json.Serialization.JsonIgnore]
        [Nest.Ignore]
        public HintSmlouva.PolitickaAngazovanostTyp RecipientPolitickyAngazovanySubjektEnum
        {
            get => (HintSmlouva.PolitickaAngazovanostTyp)this.RecipientPolitickyAngazovanySubjekt;
        }
        ...
        public static readonly Dictionary<CalculatedCategories, string[]> ProgramsDictionary = new()
        {
            ...
            },
            {
                CalculatedCategories.Doprava, new[]
                {
                    ...
                    "Program na podporu aplikovaného výzkumu a inovací v oblasti dopravy DOPRAVA 2030 agregace",
                    "Z771601000000",
            ...
            },
            {
                CalculatedCategories.HumanitarniPomoc, new[]
                {
                    ...
                    "Zvládání dopadů uprchlické vlny související s invazí Ruské federace na Ukrajinu prostřednictvím nestátních neziskových organizací provozujících evropské krizové či asistenční linky 116 XXX v České republice agregace",
                    "Z143401000000",
                }
            },
            {
                CalculatedCategories.InovaceVyzkum, new[]
                {
                    ...
                    "Podpora mobility výzkumných pracovníků a pracovnic v rámci mezinárodní spolupráce ve VaVaI agregace",
                    "Z331601000000",
            ...
            },
            {
                CalculatedCategories.Kultura, new[]
                {
                    ...
                    "Podpora veřejně prospěšných aktivit spolků osob se zdravotním postižením agregace",
                    "Z040601000000",
            ...
            },
            {
                CalculatedCategories.Obrana, new[]
                {
                    ...
                    "Pořízení a tech. obnova invest. majetku ve správě Státního úřadu pro jadernou bezpečnost",
                    "375010",
                    "Pořízení skladovacích kapacit k zajištění ropné bezpečnosti ČR", "374030",
                    "Prevence a opatření ochrany obyvatelstva před jadernými, chemickými a biologickými zátěžemi",
                    "175D10300",
                    "Prevence a opatření ochrany obyvatelstva před jadernými, chemickými a biologickými zátěžemi",
                    "175D20300",
                    "Prevence a opatření ochrany obyvatelstva před jadernými, chemickými a biologickými zátěžemi",
                    ...
                    "Rezerva na mimořádné výdaje podle zákona č. 239/2000 Sb., o integrovaném záchranném systému agregace",
                    "Z980301000000",
                    "Rezerva na řešení krizových situací, jejich předcházení a odstraňování jejich následků (zákon č. 240/2000 Sb., ve znění pozdějších předpisů) agregace",
                    "Z980401000000",
                }
            },
            {
                CalculatedCategories.Pamatky, new[]
                {
                    ...
                    "Přímá podpora obcí na zachování památkového fondu včetně jeho oprav a úprav, na regionální rozvoj m",
                    "6000752022",
                    "Program na obnovu stavební obnovy a restaurování kulturních památek a památek místního významu",
                    "KUL03-23",
            ...
            },
            {
                ...
                {
                    "Podpora celostátních mezioborových sítí nestátních neziskových organizací agregace",
                    "Z040301000000",
            ...
            },
            {
                CalculatedCategories.VerejnaSprava, new string[]
                {
                    ...
                    "Pořízení a tech. obnova invest. majetku Ministerstva zahraničních věcí na území České republiky",
                    "306010",
            ...
            },
            {
                CalculatedCategories.SocialniSluzby, new[]
                {
                    ...
                    "2022_OP 1_DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6001062021",
                    "2022_OP 2_DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6001072021",
                    "2022_OP 3_ DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6001082021",
                    "2022_OP 4_DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6001092021",
                    "2022_OP 5_DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6001102021",
                    "2022_OP6_DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6001112021",
                    "2023 Podpora paliativní péče v Jihočeském kraji", "6000272023",
                    "2023_OP 1_DP Podpora služeb nedefinovaných v zákoně č. 108/2006 Sb., o sociálních službách",
                    "6000212023",
                    "2023_OP 2_DP Podpora služeb nedefinovaných v zákoně 108/2006 Sb., o sociálních službách",
                    "6000232023",
                    "2023_OP 3_DP Podpora služeb nedefinovaných v zákoně 108/2006 Sb., o sociálních službách",
                    "6000242023",
                    ...
                    "Prevence sociálně patologických jevů se zaměřením na prevenci a eliminaci domácího násilí prostřednictvím práce s násilnými osobami a osobami nezvládajícími agresi ve vztazích - 2. kolo v souvislosti se zvládáním dopadů uprchlické vlny související s invazí",
                    "Z143301000000",
                    "Prevence sociálního vyloučení a komunitní práce agregace", "Z040401000000",
                    "Program na podporu nestátních neziskových organizací v oblasti prevence rizikových typů chování",
                    "RP07-23",
            ...
            },
            {
                CalculatedCategories.Sport, new[]
                {
                    ...
                    "DOT/64/01/004652/2016",
                    "II. C. Provoz veřejně přístupných sportovišť", "DOT/64/01/006231/2018",
                    "III. C. 2. Sportovní akce celopražského významu (pro akce konané od 1. 9. 2019 do 29. 2. 2020)",
                    "DOT/61/06/010285/2019",
                    ...
                    "RJK 21 I - Pořadatelství významných aktivit celorepublikového nebo mezinárodního rozsahu na území Ji",
                    "6000302021",
                    "RJK 21 II - Reprezentace Jihočeského kraje v oblasti vědy, mládeže a sportu na mezinárodní úrovni v",
                    "6000312021",
                    "RJK 22 I - Pořadatelství významných aktivit celorepublikového nebo mezinárodního rozsahu na území Ji",
                    "6000122022",
                    "RJK 22 II - Reprezentace Jihočeského kraje v oblasti vědy, mládeže a sportu na mezinárodní úrovni v",
                    "6000132022",
            ...
            },
            {
                CalculatedCategories.Vzdelavani, new[]
                {
                    ...
                    "CZ.1.07/1.1.00/56.0197 CZ.1.07/1.1.00/56.0197 CZ.1.07/1.1.00/56.0197 CZ.1.07/1.1.00/56.0197 CZ.1.07/1.1.00/56.0197 CZ.1.07/1.1.00/56.0197",
                    ...
                    "CZ.1.07 OP Vzdělávání pro konkurenceschopnost",
                    "CZ.1.07/1.1.00/56.0550 CZ.1.07/1.1.00/56.0550 CZ.1.07/1.1.00/56.0550 CZ.1.07/1.1.00/56.0550",
                    ...
                    "CZ.1.07 OP Vzdělávání pro konkurenceschopnost",
                    "CZ.1.07/1.1.00/56.0667 CZ.1.07/1.1.00/56.0667 CZ.1.07/1.1.00/56.0667",
                    ...
                    "CZ.1.07 OP Vzdělávání pro konkurenceschopnost",
                    "CZ.1.07/1.1.00/56.0832 CZ.1.07/1.1.00/56.0832 CZ.1.07/1.1.00/56.0832",
                    ...
                    "Podpora zajištění vybraných investičních podpůrných opatření při vzdělávání dětí, žáků a studentů se speciálními vzdělávacími potřebami",
                    "133D35100",
                    ...
                    "Výstavba a obnova kapacit pro vzdělávací a tvůrčí činnost zákl. škol a školských zařízení",
                    "398221",
            ...
            },
            {
                CalculatedCategories.Zdravotnictvi, new[]
                {
                    ...
                    "Podpora zajištění lékařské pohotovostní služby na území Jčk mimo území zákl. sítě pohot. služeb",
                    "6000222022",
            ...
            },
            {
                CalculatedCategories.ZivotniProstredi, new string[]
                {
                    ...
                    "Podprogram C pro zabezpečení péče o ohrožené a handicapované volně žijící živočichy",
                    "Z150102000000",
