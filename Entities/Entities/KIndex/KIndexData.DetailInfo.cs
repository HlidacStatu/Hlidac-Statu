                ...
                switch (part)
                {
                    case KIndexParts.PercentBezCeny:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                                return $"Skrývá ceny u {Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvBezCeny, "{0} smlouvy;{0} smluv;{0} smluv")}.";
                            case KIndexLabelValues.F:
                                return $"Skrývá ceny u varujícího počtu {Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvBezCeny, "{0} smlouvy;{0} smluv;{0} smluv")} z {this.AnnualData.Statistika.PocetSmluv} smluv.";
                            default:
                                return "";
                        }
                    case KIndexParts.PercSeZasadnimNedostatkem:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.B:
                            case KIndexLabelValues.C:
                                return $"Zásadní nedostatky u {Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvSeZasadnimNedostatkem, "{0} smlouvy;{0} smluv;{0} smluv")}.";
                            case KIndexLabelValues.D:
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Zásadní nedostatky u <b>{Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvSeZasadnimNedostatkem, "{0} smlouvy;{0} smluv;{0} smluv")}</b> z {this.AnnualData.Statistika.PocetSmluv} smluv.";
                            default:
                                return "";
                        }
                    case KIndexParts.CelkovaKoncentraceDodavatelu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.F:
                                return $"Většinu peněz {Devmasters.Lang.CS.Plural.Get(this.AnnualData.CelkovaKoncentraceDodavatelu.TopDodavatele().Count(), "dostal {0} dodavatel;dostali {0} dodavatelé;dostalo {0} dodavatelů")} z {this.AnnualData.CelkovaKoncentraceDodavatelu.Dodavatele.Count()}.";
                            default:
                                return "";
                        }
                    case KIndexParts.KoncentraceDodavateluBezUvedeneCeny:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.D:
                            case KIndexLabelValues.E:
                                return $"Zakázky se skrytou cenou se koncentrují u {Devmasters.Lang.CS.Plural.Get(this.AnnualData.KoncentraceDodavateluBezUvedeneCeny.TopDodavatele().Count(), "{0} dodavatele;{0} dodavatelů;{0} dodavatelů")}.";
                            case KIndexLabelValues.F:
                                return $"Většinu zakázek se skrytou cenou {Devmasters.Lang.CS.Plural.Get(this.AnnualData.KoncentraceDodavateluBezUvedeneCeny.TopDodavatele().Count(), "dostal {0} dodavatel;dostali {0} dodavatelé;dostalo {0} dodavatelů")}.";
                            default:
                                return "";
                        }
                    case KIndexParts.KoncentraceDodavateluCenyULimitu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.F:
                                return $"Většinu zakázek s cenou u limitu VZ {Devmasters.Lang.CS.Plural.Get(this.AnnualData.KoncentraceDodavateluCenyULimitu.TopDodavatele().Count(), "dostal {0} dodavatel;dostali {0} dodavatelé;dostalo {0} dodavatelů")}.";
                            default:
                                return "";
                        }
                    case KIndexParts.KoncentraceDodavateluObory:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                                ...
                                return $"Dominance zakázek u dodavatelů se objevuje v {Devmasters.Lang.CS.Plural.Get(oboryE.Count(), "{0} oboru;{0} oborech;{0} oborech")}.";
                            case KIndexLabelValues.F:
                                var oboryF = this.AnnualData.KIndexVypocet.OboroveKoncentrace?
                                    .Radky
                                    .Where(m => KIndexLabelForPart(KIndexParts.KoncentraceDodavateluObory, m.Hodnota) >= KIndexLabelValues.D);

                                return $"Dominance zakázek u dodavatelů je výrazná v {Devmasters.Lang.CS.Plural.Get(oboryF.Count(), "{0} oboru;{0} oborech;{0} oborech")}.";
                            default:
                                return "";
                        }
                    case KIndexParts.PercSmluvUlimitu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"{Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvULimitu, "{0} smlouva má;{0} smlouvy mají;{0} smluv má")} hodnotu blízkou limitům veřejných zakázek, což může naznačovat snahu se vyhnout řádné veřejné soutěži.";
                            //return $"Zásadní nedostatky evidujeme u {Devmasters.Lang.CS.Plural.Get(data.StatistikaRegistruSmluv.PocetSmluvSeZasadnimNedostatkem, "{0} smlouva;{0} smlouvy;{0} smluv")} z {data.StatistikaRegistruSmluv.PocetSmluv}";
                            default:
                                return "";
                        }
                    case KIndexParts.PercNovaFirmaDodavatel:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Uzavřeli {Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvNovaFirma, "{0} smlouvu;{0} smlouvy;{0} smluv")} s nově založenými firmami.";
                            default:
                                return "";
                        }
                    case KIndexParts.PercUzavrenoOVikendu:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Uzavřeli {Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvOVikendu, "{0} smlouvu;{0} smlouvy;{0} smluv")} o víkendu nebo svátku.";
                            default:
                                return "";
                        }
                    ...
                    case KIndexParts.PercSmlouvySPolitickyAngazovanouFirmou:
                        switch (lbl)
                        {
                            ...
                            case KIndexLabelValues.E:
                            case KIndexLabelValues.F:
                                return $"Uzavřeli {Devmasters.Lang.CS.Plural.Get(this.AnnualData.Statistika.PocetSmluvPolitiky, "{0} smlouvu;{0} smlouvy;{0} smluv")} s firmami, jejichž majitelé či ony samy sponzorovali politické strany.";
                            default:
                                return "";
                        }
