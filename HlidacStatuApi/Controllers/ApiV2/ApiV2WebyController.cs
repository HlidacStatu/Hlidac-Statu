    ...
    public class ApiV2WebyController : ControllerBase
    {
        ...
        */
        ...
        public ActionResult<NedostupnostModel[]> TopNedostupnost(int days)
        {
            ...
            UptimeServer.HostAvailability[] topNedostupnosti1D = UptimeServerRepo.AllActiveServers24hoursStat()
                ...
                .Take(60)
                .ToArray();
            UptimeServer.HostAvailability[] topNedostupnosti7D = UptimeServerRepo.AllActiveServersWeekStat()
