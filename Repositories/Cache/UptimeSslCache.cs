...
public static class UptimeSslCache
{
    ...
    public static ValueTask<UptimeSSL[]> GetUptimeSslCacheAsync() =>
        MemoryCache.GetOrSetAsync($"_UptimeSslCache", async _ =>
            {
    ...
    public static ValueTask InvalidateUptimeSslCacheAsync() => MemoryCache.ExpireAsync($"_UptimeSslCache");
