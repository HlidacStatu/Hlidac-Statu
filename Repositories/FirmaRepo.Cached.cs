    ...
    public static partial class FirmaRepo
    {
        ...
        static FirmaRepo()
        {
            ...
            try
            {
                ...
                swl.StopPreviousAndStartNextLap(Util.DebugUtil.GetClassAndMethodName(MethodBase.GetCurrentMethod()) + " var IcaStatnichFirem");
                VsechnyStatniMestskeFirmy = FirmaVlastnenaStatemRepo.IcaStatnichFirem().ToHashSet();

                swl.StopPreviousAndStartNextLap(Util.DebugUtil.GetClassAndMethodName(MethodBase.GetCurrentMethod()) + " var IcaStatnichFirem25");
                ...
                swl.StopPreviousAndStartNextLap(Util.DebugUtil.GetClassAndMethodName(MethodBase.GetCurrentMethod()) + " var DatoveSchranky");
            ...
            swl.StopAll();
            _logger.Warning("FirmaRepo.Cached times " + swl.ToString());
