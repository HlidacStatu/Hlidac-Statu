    ...
    public static partial class Firmy
    {
        ...
        public class GlobalStatistics
        {
                ...
                int? threads = null)
            {
                ...
                else
                {
                    lock (_vsechnyUradyLock)
                    {
                        ...
                        icos.AddRange(FirmaRepo.StatutarniMestaAllCache.Get().Select(m => m.ICO));
                        //velka mesta
                        ...
                        var res = SmlouvaRepo.Searching.SimpleSearch("(issues.issueTypeId:18 OR issues.issueTypeId:12)", 1, 0,
                        ...
                        res = SmlouvaRepo.Searching.SimpleSearch("(hint.skrytaCena:1)", 1, 0,
                            SmlouvaRepo.Searching.OrderResult.FastestForScroll, aggs, platnyZaznam: true);
         ...
         Action<string> logOutputFunc = null, Action<ActionProgressData> progressOutputFunc = null)
            ...
            private static GlobalStatisticsPerYear<Smlouva.Statistics.Data> CalculateGlobalRankPerYear_UradySmlouvy(
                 int? obor = null,
                 int? threads = null,
                 Action<string> logOutputFunc = null, Action<ActionProgressData> progressOutputFunc = null
                 )
