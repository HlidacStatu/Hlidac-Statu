...
namespace HlidacStatu.Util.Cache
{
        ...
        : Manager<byte[], KeyAndId, Devmasters.Cache.File.BinaryFileCache>
    {
        ...
        public FileCacheManager(string keyPrefix, Func<KeyAndId, byte[]> func, TimeSpan expiration)
        ...
        public static FileCacheManager GetSafeInstance(string instanceName, Func<KeyAndId, byte[]> func, TimeSpan expiration)
        {
            lock (instancesLock)
            {
