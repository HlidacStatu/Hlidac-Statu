        ...
        public static class Vysledky
        {
            ...
            public static string NalezenoPocetVysledku(Nest.TotalHits hits, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                ...
                if (hits.Relation == Nest.TotalHitsRelation.EqualTo)
                    ...
                    return Capitalize(Devmasters.Lang.CS.Plural.GetWithZero((int)hits.Value, "nebyl nalezen žádný výsledek", "byl nalezen jeden výsledek", "byly nalezeny {0:### ### ##0} výsledky", "bylo nalezeno více než {0:### ### ##0} výsledků"), style);
            }
            public static string NasliJsmeVysledky(Nest.TotalHits hits, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                ...
                if (hits.Relation == Nest.TotalHitsRelation.EqualTo)
                    ...
                    return Capitalize(Devmasters.Lang.CS.Plural.GetWithZero((int)hits.Value, "nenašli jsme žádný výsledek", "našli jsme jeden výsledek", "našli jsme {0:### ### ##0} výsledky", "našli jsme více než {0:### ### ##0} výsledků"), style);
            }
            public static string PocetZaznamu(Nest.TotalHits hits, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                ...
                if (hits.Relation == Nest.TotalHitsRelation.EqualTo)
                    ...
                    return Capitalize(Devmasters.Lang.CS.Plural.GetWithZero((int)hits.Value, "žádný záznam", "jeden záznam", "{0:### ### ##0} záznamy", "více než {0:### ### ##0} záznamů"), style);
            }
            ...
            {
                return Capitalize(
                    Devmasters.Lang.CS.Plural.GetWithZero((int)pocet, "žádný výsledek", "jeden výsledek", "{0:### ### ##0} výsledky", "{0:### ### ##0} výsledků")
                    , style);
            }
            public static string NalezenoPocetVysledku(long pocet, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                return Capitalize(
                    Devmasters.Lang.CS.Plural.GetWithZero((int)pocet, "nebyl nalezen žádný výsledek", "byl nalezen jeden výsledek", "byly nalezeny {0:### ### ##0} výsledky", "bylo nalezeno {0:### ### ##0} výsledků")
                    , style);
            }
            public static string JsmeNasliVysledky(long pocet, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                return Capitalize(
                    Devmasters.Lang.CS.Plural.GetWithZero((int)pocet, "jsme nenašli žádný výsledek", "jsme našli jeden výsledek", "jsme našli {0} výsledky", "jsme našli {0:### ### ##0} výsledků")
                    , style);
            }
            public static string NasliJsmeVysledky(long pocet, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                return Capitalize(
                    Devmasters.Lang.CS.Plural.GetWithZero((int)pocet, "nenašli jsme žádný výsledek", "našli jsme jeden výsledek", "našli jsme {0:### ### ##0} výsledky", "našli jsme {0:### ### ##0} výsledků")
                    , style);
            }
            public static string PocetZaznamu(long pocet, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                return Capitalize(
                    Devmasters.Lang.CS.Plural.GetWithZero((int)pocet, "žádný záznam", "jeden záznam", "{0:### ### ##0} záznamy", "{0:### ### ##0} záznamů")
                    , style);
            }
            public static string PocetSmluv(long pocet, CapitalizationStyle style = CapitalizationStyle.NoChange)
            {
                return Capitalize(
                    Devmasters.Lang.CS.Plural.GetWithZero((int)pocet, "0 smluv", "jedna smlouva", "{0:### ### ##0} smlouvy", "{0:### ### ##0} smluv")
                    , style);
            }
