...
namespace HlidacStatu.Web.Models
{
    ...
    public class NemocniceData
    {
        ...
        public static NemocniceData Diff(NemocniceData f, NemocniceData l)
        {
            ...
            List<NemocniceData.Region> hs = new();
        ...
        {
            NemocniceData krajF = new();
            List<Region> krajFH = new();
            //int krajId = 0;
        ...
        static object _clientLockObj = new();
        public static ElasticClient Client()
        {
            if (_client == null)
            {
                lock (_clientLockObj)
                {
                    if (_client == null)
                    {
                        ConnectionSettings sett = Manager.GetElasticSearchConnectionSettings("disp_intens_pece");
